    ...
    <div className="w-100 border px-2 py-2">
      <div className="claim-heading d-flex flex-column">
        ...
        <Row>
          <Col>
            <img
              src={`http://localhost:3000/Images/${postedClaims.item_image}`}
          ...
          <Col>
            <p className="m-0">
              ...
              {postedClaims.location}
            </p>
            <p>
              <span className="fw-bold">Cateory : </span>
              {categories[postedClaims.category_id - 1]}
            </p>
          </Col>
        </Row>
      ...
      <div className="content">
        <Row>
          <Col lg="4">
            ...
            <img
              src={`http://localhost:3000/Images/${postedClaims.image}`}
          ...
          <Col>
          <div>
          <span className={`${postedClaims.status === "Rejected" ? "bg-danger" : "bg-success" } text-white fs-6`}> Status : {postedClaims.status}</span>
           
          </div>
            <div className="w-100 h-100 d-flex align-items-end py-5">
              {children}
            </div>
          </Col>
        </Row>
